...
export PATH=$HOME/miniconda/envs/r_env/bin:$HOME/miniconda/bin:$PATH
...
topic "get R version"
Rscript --version
topic "get R environment directly"
/home/vcap/app/miniconda/envs/r_env/lib/R/bin/R --slave --no-restore -e "print(Sys.getenv())"

topic "get R environment"
Rscript -e "print(Sys.getenv())" --verbose
